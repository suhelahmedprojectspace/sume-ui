...
type AccordionProps = {
   ...
   */
  variant?: "default" | "minimal" | "cards" | "glass";
  /**
...
const Accordion: React.FC<AccordionProps> & {
  ...
  const containerClasses = {
    default: "divide-y divide-gray-200/80 dark:divide-gray-800/80 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm",
    minimal: "space-y-1",
    cards: "space-y-4",
    glass: "space-y-4 backdrop-blur-sm bg-white/20 dark:bg-gray-900/20 rounded-xl border border-white/30 dark:border-gray-800/50 shadow-lg"
  };
...
const AccordionItem: React.FC<AccordionItemProps> = ({ children, className }) => {
  ...
  const itemClasses = {
    ...
    cards: cn(
      "bg-white dark:bg-gray-900 rounded-md border border-gray-200 dark:border-gray-800 shadow-sm transition-all duration-300",
     
    ),
    glass: cn(
      "bg-white/40 dark:bg-gray-900/40 backdrop-blur-md rounded-xl border border-white/30 dark:border-gray-800/50 shadow-lg transition-all duration-300",
